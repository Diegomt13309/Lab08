...
public class MainHelper extends ItemTouchHelper.SimpleCallback{
    ...
    public MainHelper(int dragDirs, int swipeDirs, RecyclerItemTouchHelperListener listener) {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            ...
            if (this.listener.getClass().getSimpleName().equals("MainActivity")) {
                backgroundViewEdit = ((MainAdapter.MyViewHolder) viewHolder).viewBackgroundEdit;
                backgroundViewDelete = ((MainAdapter.MyViewHolder) viewHolder).viewBackgroundDelete;
                foregroundView = ((MainAdapter.MyViewHolder) viewHolder).viewForeground;
            }
            //Selected item
